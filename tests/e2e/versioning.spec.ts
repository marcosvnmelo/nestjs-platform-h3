...
describe('Versioning (H3 adapter)', () => {
  ...
  describe('URI Versioning', () => {
    ...
    it('V1 - should return Hello World V1!', async () => {
    ...
    it('V2 - should return Hello World V2!', async () => {
      await request(app.getHttpServer())
        .get('/v2/')
        .expect(200)
    ...
    it('V3 - should return 404', async () => {
      await request(app.getHttpServer()).get('/v3/').expect(404);
    });

    it('No Version - should return 404', async () => {
      await request(app.getHttpServer()).get('/').expect(404);
    });

    it('V1 param - should return Parameter V1!', async () => {
      await request(app.getHttpServer())
        .get('/v1/param/hello')
        .expect(200)
        .expect('Parameter V1!');
    ...
    it('V2 param - should return Parameter V2!', async () => {
      await request(app.getHttpServer())
        .get('/v2/param/hello')
        .expect(200)
        .expect('Parameter V2!');
    ...
    it('Multiple V1 - should return Multiple Versions 1 or 2', async () => {
      await request(app.getHttpServer())
        .get('/v1/multiple')
        .expect(200)
    ...
    it('Multiple V2 - should return Multiple Versions 1 or 2', async () => {
      await request(app.getHttpServer())
        .get('/v2/multiple')
        .expect(200)
        .expect('Multiple Versions 1 or 2');
  ...
  describe('Header Versioning', () => {
    ...
    it('No Header - should return 404', async () => {
      await request(app.getHttpServer()).get('/').expect(404);
    });
