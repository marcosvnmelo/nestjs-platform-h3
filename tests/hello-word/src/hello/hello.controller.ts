...
import { extractH3Event } from '@marcosvnmelo/nestjs-platform-h3/adapter/utils';
...
export class HelloController {
  ...
  @Get('h3-event')
  getH3Event(@Req() req: H3ServerRequest): { hasH3Event: boolean } {
    return { hasH3Event: !!extractH3Event(req) };
  }
