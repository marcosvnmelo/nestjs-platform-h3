...
// WARN: This test doesn't make use of any HttpAdapter, so it doesn't matter for nestjs-platform-h3.
describe.skip('TCP pipelined frames – stack-overflow regression (CVE fix)', () => {
  ...
  }, 15_000); // NOTE: NestJS bootstrap + processing 12_000 frames needs more than the 2 s default.
});
