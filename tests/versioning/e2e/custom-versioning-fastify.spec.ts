...
describe('Custom Versioning (fastify)', () => {
  ...
  describe('without global default version', () => {
    ...
    describe('GET /', () => {
      ...
      it('V2, if two versions are requested, select the highest version', async () => {
        await request(app.getHttpServer())
          .get('/')
          .set({
      ...
      it('V2, if a non-existent version is requested, select the highest supported version', async () => {
        await request(app.getHttpServer())
          .get('/')
          .set({
            Accept:
